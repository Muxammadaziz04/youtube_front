...
async function getData(name) {
    try {
        let res = await fetch(`https://clone-you-tube.herokuapp.com/${name}`)
        res = await res.json()
        return res
    } catch (error) {
...
async function getUserVideos(userId){
    try {
        let res = await fetch(`https://clone-you-tube.herokuapp.com/videos/${userId}`)
        res = await res.json()
        renderVideos(res)
    } catch (error) {
        console.log(error.message);
...
searchForm.onsubmit = async (event) => {
    ...
    try {
        ...
        let res = await fetch(`https://clone-you-tube.herokuapp.com/videos?search=${searchInp.value}`)
        res = await res.json()
        console.log(res);
        renderVideos(res)
